...
object DataMart {
  ...
  val session: SparkSession = SparkSession.builder
    ...
    .config("spark.jars", s"${spark.mysqlConnector}:/Users/papajool/PycharmProjects/big_data_lab5/jars/config-1.4.1.jar")
    .config("spark.driver.extraClassPath", s"${spark.mysqlConnector}:/Users/papajool/PycharmProjects/big_data_lab5/jars/config-1.4.1.jar")
